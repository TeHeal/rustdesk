...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rust.teheal.cn"];
pub const PUBLIC_RS_PUB_KEY: &str = "lMVuZ5Srwdz+YRGR2gpX5AHR0WU9PBb3cxcrZVbM0fA=";
...
pub const RENDEZVOUS_PORT: i32 = 1106;
pub const RELAY_PORT: i32 = 1107;
